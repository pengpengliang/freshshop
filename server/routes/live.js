...
var Lives = require('../models/lives');
...
router.post("/addData", function(req, res, next) {
    ...
    var productId = req.body.productId;
    Lives.find({ productId: productId }, function(err, doc) {
        if (doc.length > 0) {
            res.json({
                status: '1001',
                msg: '商品已存在',
...
router.post("/editData", function(req, res, next) {
    ...
    Lives.update({ "productId": productId }, {

...
<div class="shop_list">
    ...
    <div class="list_item">
    <ul>								
        <li v-for="item in livingroomList">
...
<script>
    ...
    export default {
		...
		methods:{
			getLivingroomList(flag){
                axios.get("/livingrooms").then((result)=>{
                    var res = result.data;
                    this.livingroomList = res.result.list;
            ...
            sortPrice(flag){
                ...
                axios.get("/livingrooms/price",{
					...
					if (res.status == '0') {
                        this.sortType = true;
                        if (flag) {
                            this.livingroomList = this.livingroomList.concat(res.result.list);
            ...
            addCart(proID){
                ...
                axios.post("/livingrooms/addCart",{
                    proID:proID,
                    userId:userId
                }).then((res)=>{

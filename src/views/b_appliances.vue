...
<div class="shop_list">
    ...
    <div class="list_item">
    <ul>								
        <li v-for="item in BappliancesList">
...
<script>
    ...
    export default {
		...
		methods:{
			getBappliancesList(){
                axios.get("/bappliances").then((result)=>{
                    var res = result.data;
                    this.BappliancesList = res.result.list;
            ...
            sortPrice(flag){
                ...
                axios.get("/bappliances/price",{
					...
					if (res.status == '0') {
                        this.sortType = true;
                        if (flag) {
                            this.BappliancesList = this.BappliancesList.concat(res.result.list);
            ...
            addCart(proID){
                ...
                axios.post("/bappliances/addCart",{
                    proID:proID,
                    userId:userId
                }).then((res)=>{

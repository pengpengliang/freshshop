            ...
            sortPrice(flag){
                ...
                axios.get("/milks/price",{
					...
					if (res.status == '0') {
                        this.sortType = true;
                        if (flag) {
                            this.milkList = this.milkList.concat(res.result.list);

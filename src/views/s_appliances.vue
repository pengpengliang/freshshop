...
<div class="shop_list">
    ...
    <div class="list_item">
    <ul>								
        <li v-for="item in SappliancesList">
...
<script>
    ...
    export default {
		...
		methods:{
			getSappliancesList(flag){
               axios.get("/sappliances").then((result)=>{
                    var res = result.data;
                    this.SappliancesList = res.result.list;
            ...
            sortPrice(flag){
                ...
                axios.get("/sappliances/price",{
					...
					if (res.status == '0') {
                        this.sortType = true;
                        if (flag) {
                            this.SappliancesList = this.SappliancesList.concat(res.result.list);
            ...
            addCart(proID){
                ...
                axios.post("/sappliances/addCart",{
                    proID:proID,
                    userId:userId
                }).then((res)=>{
